...
public class Task4 {
    public static void main(String[] args) {
        ...
        int devision = ((int) median) / 2;  //получаем деление среднеарифметического на 2, а также округляем его в меньшую сторону (с посощью перевода типа данных из double в int)

        System.out.println("Среднее арифметическое введеных чисел: " + median);
        System.out.println("Среднее арифметическое введеных чисел поделенное на 2: " + devision);
